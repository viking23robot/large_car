...
unsigned char ir_rec_flag=0;   //红外头接收数据标志位 1 有新数据 0 没有
unsigned char IRCOM[4];        //储存红外遥控发射数据
unsigned char continue_time=0; //停车时间
char IrDA = 0;//红外控制指令
  ...
  unsigned char j,k,N=0;
     ...
     { 
	   return;
		 ...
		 continue_time = 30;//连发信号，表示指令持续 30*5 =150ms 无指令停车
                           //确认IR信号出现
